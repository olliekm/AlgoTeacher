    ...
    <main className="flex min-h-screen flex-col">
              <AnimatePresence initial={false}>
                ...
                className="h-screen w-full fixed top-0 left-0 bg-gradient-to-r flex flex-col justify-center pl-24 from-indigo-500/90 via-green-20/80 to-purple-700/0 z-20 backdrop-blur-sm">
                    <motion.h1 variants={goodText} className='text-8xl font-serif pb-8'>
                        ...
                        <motion.button variants={goodText} className='text-4xl  bg-white text-indigo-600 rounded-2xl px-12 py-4 w-min hover:bg-transparent border-2 border-white hover:text-white duration-150'>
                    <Link href={'/'}>
                            Back to AlgoTeacher
                    </Link>
                        </motion.button>
      ...
      <div className=" p-24 pb-8">
        ...
        />
                ...
                <div onClick={() => setFinish(true)} className="w-full flex flex-col h-96 overflow-hidden cursor-pointer bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-emerald-900 via-violet-600/0 to-sky-900/0  hover:from-emerald-800 hover:via-violet-600/0 hover:to-sky-900/0 justify-center items-center transition-colors duration-200 group">
                <motion.h1 


                class="bg-[conic-gradient(at_top,_var(--tw-gradient-stops))] from-gray-900 via-gray-100 to-gray-900 group-hover:tracking-[.3em] ease-in duration-75  text-5xl inline-block text-transparent bg-clip-text font-serif mt-8">Complete lesson</motion.h1>

                <motion.h1 

                class="bg-[conic-gradient(at_top,_var(--tw-gradient-stops))] from-gray-900 via-gray-100 to-gray-900 text-xl inline-block text-transparent bg-clip-text font-serif mt-8">Apply what you learned</motion.h1>
